...
<body>
          ...
          <section id="fancy-form" style="background-image: url(images/Screenshot\ \(142\).png);">
            <div class="container">
             <div class="form-sections">
               ...
               <div class="Form-left">
                 ...
                 <p style="color: azure;">Contact us for latest news and updates. subscribe our news letter :)</p><br>
          
                 <!--first Heading -->
                 <h4>ADDRESS</h4>
                  <span style="color: azure;">123, Main Street, beirut-Lebanon 1500</span>
                  <hr><br><br>
          
                  <!--second Heading -->
                 <h4>PHONE</h4>
                  <span style="color: azure;">(+961) 76 882 551</span>
                  <hr><br><br>
          
                <!--third Heading -->
                 <h4>EMAIL</h4>
                  <span style="color: azure;">Hebarachid11@gmail.com</span>
                  <hr> <br>
...
<input type="text" name="name" placeholder="Enter your name" value="<?php echo $_POST["name"] ?>" style="background: azure; color: black;">

<h5>
<label for="email">Email</label>
</h5>
<input type="text"  name="email" placeholder="Enter your email"
        value="<?php echo $_POST["email"] ?>"  style="background: azure; color: black;">
<h5>
<label for="phone">PHONE</label>
</h5>
<input type="number" name="phone"  value="<?php echo $_POST["number"] ?>" style="background: azure; color: black;">
<br><br>
<div class="form-group">
<h5>
<label for="message">Message</label></h5>

<textarea class="form-control" name="message"  id="" cols="50" rows="4" style="background: azure; color: black;"><?php $_POST["message"]; ?></textarea><br> </div>
...
foreach($errors as $error){
 ...
 ?>
    ...
    <footer class="bg-dark px-5">
        ...
        <p class="small">You can visit and donate or you can sign in and pay with your credit-card or you can even participate in the events</p>
        </div>
        ...
        <ul class="list-unstyled">
            ...
            <li> <a href="#" class="footer-link">SponsorChildren</a>  </li>
        ...
        <li><a href="#" class="text-info">AbolishPoverty@gmail.com</a></li>
        ...
        <div class="col-lg-4 col-sm-6">
            ...
            <p class="small">Email us, contact us, visite us. We reply within minutes !!</p>
